...
(cl:defmethod cl:initialize-instance :after ((m <control>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'control)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name study_pkg-msg:<control> is deprecated: use study_pkg-msg:control instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <control>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader study_pkg-msg:x-val is deprecated.  Use study_pkg-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <control>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader study_pkg-msg:y-val is deprecated.  Use study_pkg-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <control>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader study_pkg-msg:z-val is deprecated.  Use study_pkg-msg:z instead.")
  (z m))
