...
let LearningGoal = require('./LearningGoal.js');
let std_msgs = _finder('std_msgs');
let actionlib_msgs = _finder('actionlib_msgs');

//-----------------------------------------------------------

class LearningActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = LearningGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LearningActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = LearningGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new LearningGoal()
    }
...
module.exports = LearningActionGoal;
